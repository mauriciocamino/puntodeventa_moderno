...
// Add Script
// $document->addScript('../assets/template/angular/modals/PurchaseProductModal.js');
$document->addScript('../assets/template/angular/controllers/StockAlertController.js');
