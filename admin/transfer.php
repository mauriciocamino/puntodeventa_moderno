...
// Add Script
$document->addScript('../assets/template/angular/modals/TransferDetailsViewModal.js');
$document->addScript('../assets/template/angular/modals/TransferEditModal.js');
$document->addScript('../assets/template/angular/controllers/TransferController.js');
