...
// Add Script
$document->addScript('../assets/template/angular/modals/PurchaseReturnViewModal.js');
$document->addScript('../assets/template/angular/controllers/PurchaseReturnController.js');
