		...
		<div id="reset-form">
			<div class="container">
				<div class="container-inner">
					<h2 class="alert success">Restablecer hecho con éxito!</h2>
				</div>
				<div class="buttons">
					<a class="btn back" href="<?php echo root_url();?>/admin/dashboard.php">&larr;Volver al panel</a>
				</div>
			</div>
		</div>
		<?php else:?>
					...
					<div class="container">
						<div class="container-inner">
							<?php if (!empty($errors)):?>
								...
								<?php endforeach;?>				
							<?php endif;?>
							<h2 class="title">REINICIO DE DATOS <br><?php echo store('name');?></h2>
							<h4 class="text">Vas a restablecer tu sistema. Esta acción eliminará todos los datos y no se podran restaurar nuevamente. Si aún continúa con esta acción, haga clic en 'Sí'; de lo contrario, haga clic en el botón 'No'.</h4>
						</div>
						<div class="store-container">
							...
							<div class="store-selector">
								<div class="checkbox selector">
									<label class="label">
										<input type="checkbox" onclick="$('input[name*=\'store\']').prop('checked', this.checked);"> 
