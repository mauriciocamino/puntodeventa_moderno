						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								...
								<div class="well wel-sm">
									<i>
Para la instalación local en una sola máquina: PHP Server será la mejor opción y para el servidor en vivo o la configuración del servidor local (LAN): puede instalar PHP Pos Print Server localmente en cada máquina (recomendado) o utilizar la función de impresión del navegador web.</i>
								</div>
								<div class="well wel-sm">
									<div class="form-group">
										<div class="col-sm-6">
