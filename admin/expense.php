...
// Add Script
$document->addScript('../assets/template/angular/modals/ExpenseViewModal.js');
$document->addScript('../assets/template/angular/modals/ExpenseEditModal.js');
$document->addScript('../assets/template/angular/controllers/ExpenseController.js');
