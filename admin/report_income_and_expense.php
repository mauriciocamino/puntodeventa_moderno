...
// Add Script
$document->addScript('../assets/template/angular/controllers/ReportIncomeController.js');
$document->addScript('../assets/template/angular/controllers/ReportExpenseController.js');
  ...
  <section class="content">
    ...
    <div class="box box-default" id="income-expense-report">
      <div class="box-header bg-info">
        <h3 class="box-title">
          <?php if (from()) : ?>
            <?php echo trans('text_date'); ?>: <?php echo trans_date(date("j M Y", strtotime(from())));?>
          <?php else: ?>
            <?php echo trans('text_date'); ?>: <?php echo trans_date(date("j M Y", time()));?>
          <?php endif; ?>
        </h3>
