...
// Add Script
$document->addScript('../assets/template/angular/controllers/ReportLossController.js');
$document->addScript('../assets/template/angular/controllers/ReportProfitController.js');
    ...
    <div class="box box-default">
      <div class="box-header bg-info">
        <h3 class="box-title">
          ...
          <?php if (from()) : ?>
            (<?php echo trans_date(date("j M Y", strtotime(from())));?>)
          <?php else: ?>
            (<?php echo trans_date(date("j M Y", time()));?>)
          <?php endif; ?>
        </h3>
      </div>
