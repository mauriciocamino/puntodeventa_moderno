...
// Add Script
$document->addScript('../assets/template/angular/modals/CustomerTransactionViewModal.js');
$document->addScript('../assets/template/angular/controllers/CustomerTransactionController.js');
