...
// Add ScriptS
$document->addScript('../assets/template/angular/modals/InstallmentPaymentModal.js');
$document->addScript('../assets/template/angular/modals/InstallmentViewModal.js');
$document->addScript('../assets/template/angular/modals/CustomerSubstractBalanceModal.js');
$document->addScript('../assets/template/angular/modals/CustomerAddBalanceModal.js');
$document->addScript('../assets/template/angular/controllers/CustomerController.js');
$document->addScript('../assets/template/angular/controllers/CustomerProfileController.js');
