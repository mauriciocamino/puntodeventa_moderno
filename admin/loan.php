...
// Add Script
$document->addScript('../assets/template/angular/modals/LoanPayModal.js');
$document->addScript('../assets/template/angular/modals/LoanViewModal.js');
$document->addScript('../assets/template/angular/modals/LoanCreateModal.js');
$document->addScript('../assets/template/angular/modals/LoanEditModal.js');
$document->addScript('../assets/template/angular/modals/LoanDeleteModal.js');
$document->addScript('../assets/template/angular/controllers/LoanController.js');
