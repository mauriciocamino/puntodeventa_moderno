...
// 	$document->addScript('../assets/template/angular/controllers/ReportProductSellController.js');
// }
if (user_group_id() == 1 || has_permission('access', 'read_purchase_report')) {
	$document->addScript('../assets/template/angular/controllers/ReportProductPurchaseController.js');
}
			    ...
			    <div class="nav-tabs-custom">
	                ...
	                <div class="tab-content">
	                    ...
	                    <div class="tab-pane" id="chart">
	                    	<?php
	                    	if (from()) {
	                    		$label = 'Desde ' . from() . ' A ' . to();
	                    	} else {
	                    		$label = 'Fecha:  ' . date('Y-m-d');
	                    	}
	                    	$labels = array($label); 
