...
// Add Script
$document->addScript('../assets/template/angular/controllers/ReportIncomeDaywiseController.js');
$document->addScript('../assets/template/angular/controllers/ReportExpenseDaywiseController.js');
    ...
    <div class="box box-default">
      <div class="box-header bg-warning">
        ...
        if (from()): ?>
          ...
          <?php else: ?>
            <div style="display: inline-block;" class="apply-filter">
                <a href="<?php echo relative_url().$query_string; ?>" class="btn btn-xs btn-info mb-0" title="Quitar este filtro">
