...
if (user_group_id() != 1 && $request->get['id'] == 1) {
  redirect(root_url() . '/'.ADMINDIRNAME.'/dashboard.php');
}
...
// Add ScriptS
$document->addScript('../assets/template/angular/controllers/UserController.js');
$document->addScript('../assets/template/angular/controllers/UserProfileController.js');
$document->addScript('../assets/template/angular/controllers/ReportUserSellController.js');
$document->addScript('../assets/template/angular/controllers/UserLoginLogController.js');
