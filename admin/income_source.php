...
// Add Script
$document->addScript('../assets/template/angular/modals/IncomeSourceEditModal.js');
$document->addScript('../assets/template/angular/modals/IncomeSourceDeleteModal.js');
$document->addScript('../assets/template/angular/controllers/IncomeSourceController.js');
