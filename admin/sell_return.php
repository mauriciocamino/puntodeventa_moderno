...
// Add Script
$document->addScript('../assets/template/angular/modals/SellReturnViewModal.js');
$document->addScript('../assets/template/angular/controllers/SellReturnController.js');
