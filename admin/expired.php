...
// Add Script
$document->addScript('../assets/template/angular/modals/ProductEditModal.js');
$document->addScript('../assets/template/angular/controllers/ExpiredProductController.js');
