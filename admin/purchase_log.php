...
// Add Script
$document->addScript('../assets/template/angular/modals/PurchaseLogViewModal.js');
$document->addScript('../assets/template/angular/controllers/PurchaseLogController.js');
