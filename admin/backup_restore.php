...
// Add Script
$document->addScript('../assets/template/js/backup-restore.js');
    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="alert alert-warning mb-0">
          <p><span class="fa fa-fw fa-info-circle"></span> Las funciones de copia de seguridad / restauración están deshabilitadas en la versión de demostración</p>
        </div>
      </div>
    </div>
    <?php endif; ?>
                      ...
                      <div filter-list="search_table">
                        <?php foreach (get_all_tables() as $table): if (in_array($table[0], array('users','user_group','user_to_store'))) continue;?>
                          <div>
                              ...
                              <label>
                                <?php echo trans_spa_table($table[0]); ?>
                              </label>
                          </div>
                        <?php endforeach; ?>  
                      </div> 
          ...
          <?php if(user_group_id() == 1 || has_permission('access', 'restore')) : ?>
            <div class="tab-pane" id="restore">
              <div class="alert alert-info">
                <p><span class="fa fa-fw fa-info-circle"></span> El proceso de restauración puede tardar varios minutos en completarse. Nunca cierre su navegador antes del proceso; de lo contrario, el sistema podría romperse y no funcionar correctamente.</p>
              </div>
