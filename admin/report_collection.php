...
// Add Script
$document->addScript('../assets/template/angular/controllers/ReportCollectionController.js');
$document->addScript('../assets/template/angular/modals/UserInvoiceDetailsModal.js');
$document->addScript('../assets/template/angular/modals/DueCollectionDetailsModal.js');
