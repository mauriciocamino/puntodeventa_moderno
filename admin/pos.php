...
<head>
    ...
    <?php if (store('favicon')): ?>
		<link rel="shortcut icon" href="../assets/template/img/logo-favicons/<?php echo store('favicon'); ?>">
	<?php else: ?>
		<link rel="shortcut icon" href="../assets/template/img/logo-favicons/nofavicon.png">
	<?php endif; ?>
	...
	<?php if (DEMO || USECOMPILEDASSET) : ?>
		...
		<link href="../assets/template/cssmin/pos.css" type="text/css" rel="stylesheet">
	...
	<?php else : ?>
		...
		<!-- Filemanager CSS -->
	    <link href="../assets/template/css/filemanager/dialogs.css" type="text/css" rel="stylesheet">
	    <link href="../assets/template/css/filemanager/main.css" type="text/css" rel="stylesheet">

	    <!-- Theme CSS -->
	    <link href="../assets/template/css/theme.css" type="text/css" rel="stylesheet">

	    <!-- Skin Black CSS -->
	    <link href="../assets/template/css/skins/skin-black.css" type="text/css" rel="stylesheet">

	    <!-- Skin Blue CSS -->
	    <link href="../assets/template/css/skins/skin-blue.css" type="text/css" rel="stylesheet">

	    <!-- Skin Green CSS -->
	    <link href="../assets/template/css/skins/skin-green.css" type="text/css" rel="stylesheet">

	    <!-- Skin Red CSS -->
	    <link href="../assets/template/css/skins/skin-red.css" type="text/css" rel="stylesheet">

	    <!-- Skin Yellow CSS -->
	    <link href="../assets/template/css/skins/skin-yellow.css" type="text/css" rel="stylesheet">

	    <!-- Main CSS -->
	    <link href="../assets/template/css/main.css" type="text/css" rel="stylesheet">

		<!-- Skeleton CSS -->
		<link href="../assets/template/css/pos/skeleton.css" rel="stylesheet" type="text/css">

		<!-- Main CSS -->
		<link href="../assets/template/css/pos/pos.css" rel="stylesheet" type="text/css">

		<!-- Responsive CSS -->
		<link href="../assets/template/css/pos/responsive.css" rel="stylesheet" type="text/css">
	...
	<style type="text/css">
		body::after { 
			content: ""; background: url(../assets/template/img/pos/patterns/<?php echo $user->getPreference('pos_pattern') ? $user->getPreference('pos_pattern') : 'armysuit.jpg'; ?>) repeat repeat;opacity: 0.4;filter: alpha(opacity=40);top: 0;left: 0;bottom: 0;right: 0;position: absolute;z-index: -1;
		}
...
<div class="hidden"><?php include('../assets/template/img/iconmin/icon.svg');?></div>
<?php include('../_inc/template/pos_skeleton.php'); ?>
						...
						<div class="contents">
							...
							<div id="item-list">
								...
								<div ng-show="showLoader" class="ajax-loader">
									<img src="../assets/template/img/loading2.gif">
								</div>
								...
								<div ng-repeat="products in productArray" id="{{ $index }}" class="btn btn-flat item">
									<div ng-click="addItemToInvoice(products.p_id,products)" class="item-inner">
										...
										<span class="item-info" data-id="{{ products.p_id }}" data-name="{{ products.p_name }}">
											<span>
												{{ products.p_name | cut:true:20:' ...' }} <br>$ {{ products.price }} Und.
											</span>
										</span>
										...
										<span ng-show="products.disc>'0'"class="ibadge2">Dcto {{ products.disc }}%</span>
									</div>
								</div>
							...
							<div class="well well-sm">
												...
												<tr ng-repeat="items in itemArray" class="invoice-item">
													...
													<td class="product-price">
														<?php if (get_preference('change_item_price_while_billing') == 1) : ?>
															<input type="text" class="text-center item_price" id="item_price_{{ items.id }}" name="item_price_{{ items.id }}" value="{{ items.price | number }}" data-itemid="{{ items.id }}" onClick="this.select();" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" style="max-width:80px;padding:5px;border-radius: 20px;border:2px solid #ddd;">
														<?php else : ?>
															{{ items.price | number }}
														<?php endif; ?>
													</td>
													...
													<td class="hide descuento" >{{items.quantity}}--{{items.discount}}--{{items.price}}</td>
												</tr>
											</tbody>
										</table>
									</div>
								...
								<div id="pay-button" class="text-center">
									<div class="btn-group btn-group-justified">
										<div class="btn-group">
											<button ng-click="payNow()" onClick="return false;" class="btn btn-success" data-loading-text="Procesando..." title="Pagar">
												<span class="fa fa-fw fa-money"></span> 
												<?php echo trans('button_pay'); ?>
											</button>
										</div>
								<div class="btn-group">
											<button ng-click="HoldingOrderModal()" on-click="return false;" class="btn btn-danger" data-loading-text="Procesando..." title="Pedidos">
	...
	<?php if (DEMO || USECOMPILEDASSET) : ?>
		...
		<script src="../assets/template/jsmin/pos.js" type="text/javascript"></script>
	...
	<?php else : ?>
		...
		<!-- Angular JS -->
	    <script src="../assets/template/angularmin/angular.js" type="text/javascript"></script> 

	    <!-- AngularApp JS -->
	    <script src="../assets/template/angular/angularApp.js" type="text/javascript"></script>

	    <!-- Filemanager JS -->
	    <script src="../assets/template/angularmin/filemanager.js" type="text/javascript"></script>

	    <!-- Angular JS Modal -->
		<script src="../assets/template/angularmin/modal.js" type="text/javascript"></script>
		...
		<!-- IE JS -->
		<script src="../assets/template/js/ie.js" type="text/javascript"></script>

		<!-- Common JS -->
		<script src="../assets/template/js/common.js" type="text/javascript"></script>

		<!-- Main JS -->
		<script src="../assets/template/js/main.js" type="text/javascript"></script>

		<!-- POS Main JS -->
		<script src="../assets/template/js/pos/pos.js" type="text/javascript"></script>

<?php endif; ?>

<script src="../assets/template/angular/modals/AddInvoiceNoteModal.js" type="text/javascript"></script>
<script src="../assets/template/angular/modals/AddCustomerMobileNumberModal.js" type="text/javascript"></script>
<script src="../assets/template/angular/modals/HoldingOrderModal.js" type="text/javascript"></script>
<script src="../assets/template/angular/modals/HoldingOrderDetailsModal.js" type="text/javascript"></script>
<script src="../assets/template/angular/controllers/PosController.js" type="text/javascript"></script>
<noscript>
