...
// Add Script
$document->addScript('../assets/template/angular/modals/ExpenseCategoryEditModal.js');
$document->addScript('../assets/template/angular/modals/ExpenseCategoryDeleteModal.js');
$document->addScript('../assets/template/angular/controllers/ExpenseCategoryController.js');
