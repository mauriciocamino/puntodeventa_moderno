...
// Add Style
$document->addStyle('../assets/template/css/barcode.css', 'stylesheet', 'all');

// Add Script
$document->addScript('../assets/template/angular/controllers/BarcodePrintController.js');
              ...
              if(isset($request->post['products'])):
                ...
                ?>
                  ...
                  <div class="text-center">
                    <div class="btn-group">
                      <button class="btn btn-warning" onClick="window.printContent('barcode-con', {title:'<?php echo trans('text_barcode_print');?>',screenSize:'fullScreen', cssLink:'<link type=\'text/css\' href=\'../assets/template/css/barcode.css\' type=\'text/css\' rel=\'stylesheet\'>'});"><span class="fa fa-print"></span> <?php echo trans('button_print');?></button>
                    </div>
                  </div>
                        ...
                        <div class="item-inner">
                          <?php if (isset($request->post['fields']['product_image']) && $request->post['fields']['product_image']):?>
                            <span class="product_image">
                              ...
                              <?php else : ?>
                                <img src="../assets/template/img/noimage.jpg">
                              <?php endif; ?>
                            </span>
                          <?php endif;?>
                          <?php if (isset($request->post['fields']['site_name']) && $request->post['fields']['site_name']):?>
