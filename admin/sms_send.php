...
$document->addScript('../assets/template/angular/controllers/SMSController.js');
  ...
  <section class="content">
    ...
    <div class="box box-info">
      ...
      <div class="box-footer">
        <p class="text-blue"><i>* El envío de SMS es una tarea que requiere mucho tiempo. Puede tomar de unos segundos a unos minutos, incluso varios minutos en completarse. Por lo tanto, es muy recomendable configurar Cronjob en Linux o Programar una tarea en Windows para facilitar esta tarea.</i></p>
      </div>
    </div>
