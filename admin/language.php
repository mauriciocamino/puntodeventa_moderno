...
// Add Script
$document->addScript('../assets/template/angular/modals/LanguageCreateModal.js');
$document->addScript('../assets/template/angular/modals/LanguageEditModal.js');
$document->addScript('../assets/template/angular/controllers/LanguageController.js');
