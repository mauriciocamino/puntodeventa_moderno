						...
						<?php foreach ($payments as $payment): ?>
                          	<tr class="bt-1">
	                            ...
	                            <td class="w-10 text-center">
	                                <?php echo trans_spa(ucfirst($payment['payment_status']));?>
	                            </td>
	                            <td class="w-10 text-center">
			...
			<table class="table table-bordered table-striped mb-0">
				<tbody>
					...
					<tr>
						...
						<td class="w-70">
							<?php echo $invoice['duration']; ?> Dias
						</td>
					</tr>
					<tr>
						<td class="w-30 text-right bg-gray">
						...
						<td class="w-70">
							<?php echo $invoice['interval_count']; ?> Dias
						</td>
					</tr>
					<tr>
						<td class="w-30 text-right bg-gray">
					...
					<tr>
						...
						<td class="w-70 <?php echo $invoice['payment_status'] == 'due' ? 'text-red' : 'text-green';?>">
							<?php echo trans_spa(ucfirst($invoice['payment_status'])); ?>
						</td>
					</tr>
					<tr>
						<td class="w-30 text-right bg-gray">
						...
						<td class="w-70">
							<?php echo trans_date(date("j M Y g:i A", strtotime($invoice['last_installment_date']))); ?>
						</td>
					</tr>
					<tr>
						<td class="w-30 text-right bg-gray">
						...
						<td class="w-70">
							<?php echo trans_date(date("j M Y", strtotime($invoice['installment_end_date']))); ?>
						</td>
					</tr>
					<tr>
						<td class="w-30 text-right bg-gray">
						...
						<td class="w-70">
							<?php echo trans_date(date("j M Y g:i A", strtotime($invoice['created_at']))); ?>
						</td>
					</tr>
				</tbody>
			</table>
