                ...
                <td class="text-center">
                  <div class="image-thumbnail">
                    <a class="open-filemanager" data-imageid="{{img.id}}" data-toggle="image" id="thumb{{img.id}}" href="#">
                      ...
                      <img ng-show="!img.url" src="../assets/template/img/noimage.jpg">
                    </a>
                  </div>
                </td>
                <td>
        ...
        <div class="tab-pane<?php echo $tab_active == 'general' ? ' active' : null;?>" id="general">
          ...
          <div class="form-group">
            ...
            <label for="discount" class="col-sm-3 control-label">
              <?php echo trans('label_unit_discount'); ?>
            </label>
            <div class="col-sm-8">
              <input type="text" class="form-control" id="discount" name="discount" value="<?php echo $product['discount'] ?>" onkeypress="return IsNumeric(event);" >
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8 store-selector">
              <div class="checkbox selector">
                <label>
                  <input type="checkbox" onclick="$('input[name*=\'product_store\']').prop('checked', this.checked);"> 
