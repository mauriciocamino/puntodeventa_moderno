...
<form id="currency-form" class="form-horizontal" action="currency.php" method="post" enctype="multipart/form-data">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="title" value="<?php echo isset($currency['title']) ? $currency['title'] : null; ?>" placeholder="Escriba el título de la moneda" name="title" required>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="code" value="<?php echo isset($currency['code']) ? $currency['code'] : null; ?>" placeholder="Escriba el código de moneda" name="code" required>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="symbol_left" value="<?php echo isset($currency['symbol_left']) ? $currency['symbol_left'] : null; ?>" placeholder="Escriba el símbolo de la izquierda" name="symbol_left">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="symbol_right" value="<?php echo isset($currency['symbol_right']) ? $currency['symbol_right'] : null; ?>" placeholder="Escriba el símbolo de la derecha" name="symbol_right">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="number" class="form-control" id="decimal_place" value="<?php echo isset($currency['decimal_place']) ? $currency['decimal_place'] : null; ?>" placeholder="Escriba el lugar decimal" name="decimal_place" required>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6 store-selector">
        <div class="checkbox selector">
          <label>
            <input type="checkbox" onclick="$('input[name*=\'currency_store\']').prop('checked', this.checked);"> 
