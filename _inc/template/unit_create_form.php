    ...
    <div class="form-group">
      ...
      <div class="col-sm-7">
        ...
        <label for="discount" class="col-sm-3 control-label">
          <?php echo trans('label_unit_discount'); ?><i class="required">*</i>
        </label>
        <div class="col-sm-7">
          <input type="text" class="form-control" id="discount" value="0" name="discount" required>
        </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-7 store-selector">
        <div class="checkbox selector">
          <label>
            <input type="checkbox" onclick="$('input[name*=\'unit_store\']').prop('checked', this.checked);"> 
