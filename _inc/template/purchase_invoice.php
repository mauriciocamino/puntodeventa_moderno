			...
			<table class="table table-bordered table-striped table-condensed">
				<tbody>
					...
					<tr>
						...
						<td class="w-70">
							<?php echo ucfirst(trans_spa($invoice['payment_status'])); ?>
						</td>
					</tr>
					<tr>
						<td class="w-30 bg-gray text-right">
                          ...
                          <tr class="bt-1 <?php echo $color;?>">
                            <td class="w-50 text-right">
                              <?php if ($row['type'] == 'return') : ?>
                                <small><i>El retorno el</i></small> <?php echo $row['created_at'];?> <small><i> por </i></small> <?php echo get_the_user($row['created_by'], 'username');?>
                              <?php elseif ($row['type'] == 'change') : ?>
                                <small><i>Cambiar el </i></small> <?php echo $row['created_at'];?> <small><i> por </i></small> <?php echo get_the_user($row['created_by'], 'username');?>
                              <?php elseif ($row['type'] == 'discount') : ?>
                                <small><i>Descuento el </i></small> <?php echo $row['created_at'];?> <small><i> por </i></small> <?php echo get_the_user($row['created_by'], 'username');?>
                              <?php elseif ($row['type'] == 'due_paid') : ?>
                                <small><i>Cuotas pagadas el</i></small> <?php echo $row['created_at'];?> 
