<form class="form-horizontal" id="balance-form" action="customer.php" method="post">
  	...
  	<div class="box-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" id="amount" name="amount" placeholder="cantidad" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" onKeyUp="if(this.value<0){this.value='1';}" required>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
			  <textarea class="form-control" id="note" name="note" placeholder="nota aquí"></textarea>
			</div>
		</div>
		<div class="form-group">
