  ...
  <a href="dashboard.php" class="logo">
    <span class="logo-mini">
      <b title="<?php echo store('name');?>">
        <?php echo 'T';// store('name')[0]; ?>
      </b>
      <?php echo 'M';//mb_substr(store('name'), -1); ?>
    </span>
    <span class="logo-lg">
      <b title="<?php echo store('name');?>">
        <?php echo 'MAC POS' ?>
    ...
    <ul class="nav navbar-nav navbar-left">
      <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="<?php echo $user->getAllPreference()['language'];?>">
          <img src="../assets/template/img/flags/<?php echo $user->getAllPreference()['language'];?>.png" alt="<?php echo $user->getAllPreference()['language'];?>"></a>
          ...
          <?php foreach(get_langs() as $the_lang): if($user->getAllPreference()['language'] == $the_lang['slug']) continue; ?>
            <li>
              <a href="<?php echo $_SERVER['PHP_SELF'];?>?lang=<?php echo $the_lang['code'];?>" title="<?php echo trans('text_'.$the_lang['slug']); ?>">
                <img src="../assets/template/img/flags/<?php echo $the_lang['code'];?>.png" class="language-img"> &nbsp;&nbsp;<?php echo trans('text_'.$the_lang['slug']); ?>
              </a>
            </li>
          <?php endforeach; ?>
        </ul>
      ...
      <li>
        <a href="#"><?php echo limit_char(store('name'), 20); ?></a>
      </li>
      <li><a href="#" onClick="return false;" id="live_datetime"></a> </li>
    </ul>
