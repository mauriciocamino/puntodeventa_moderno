...
$document->addScript('../assets/template/angular/controllers/InvoiceViewController.js'); 
?>
...
<div class="table-responsive footer-actions">
  <table class="table">
    <tbody>
      <tr class="no-print">
        <td colspan="2">
          <button id="invoice_print" value="<?php echo $invoice_id;?>" class="btn btn-info btn-block">
