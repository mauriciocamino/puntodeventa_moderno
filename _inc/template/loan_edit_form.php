<form id="loan-edit-form" class="form-horizontal" action="loan.php" method="post" enctype="multipart/form-data">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" value="<?php echo $loan['loan_from'];?>" name="loan_from" autocomplete="off">
      ...
      <div class="col-sm-8">
        <div class="preview-thumbnail">
          <a ng-click="POSFilemanagerModal({target:'image',thumb:'image_thumb'})" onClick="return false;" href="#" data-toggle="image" id="image_thumb">
            ...
            <?php else : ?>
              <img src="../assets/template/img/noimage.jpg" width="40" height="50">
            <?php endif; ?>
          </a>
