...
$columns = array(
  ...
  array( 
      ...
      'formatter' => function( $d, $row ) {
        return '<span class="label label-warning">'.trans_spa(ucfirst(str_replace('_',' ',$row['type']))).'</span>';
      }
    ),
  ...
  array( 
    ...
    'formatter' => function($d, $row) {
      ...
      $detalle = !empty($row['details']) ? get_the_pmethod($row['pmethod_id'], 'name')." - ".$row['details'] : get_the_pmethod($row['pmethod_id'], 'name');
