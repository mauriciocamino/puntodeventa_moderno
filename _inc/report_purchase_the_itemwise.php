    ...
    array( 
      ...
      'formatter' => function( $d, $row ) {
        if ($row['status'] == 'active') {
          return '<span class="label label-success">'.trans_spa($row['status']).'</span>';
        } elseif ($row['status'] == 'stock') {
          return '<span class="label label-info">'.trans_spa($row['status']).'</span>';
        } else {
          return '<span class="label label-danger">'.trans_spa($row['status']).'</span>';
        }
      }
    ),
);
