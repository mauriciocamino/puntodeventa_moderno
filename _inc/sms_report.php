...
$columns = array(
  ...
  array( 
    ...
    'dt' => 'process_status' ,
    'formatter' => function($d, $row) {
      if ($row['delivery_status'] == 'Enviado') {
        return '<span class="label label-warning">Enviado</span>';
      } elseif ( $row['delivery_status'] == 'Reenviado') {
        return '<span class="label label-info">Reenviado</span>';
      } elseif ($row['response_text']) {
        return '<span class="label label-danger">Error</span>';
      } else {
        return '<span class="label label-warning">Procesando...</span>';
      }
    }
  ),
  // array( 
