        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: window.customerName + " - Lista de facturas -"+from+" al "+to,
                stripHtml: false,
                customize: function ( win ) {
                    $(win.document.body)
                        ...
                        .prepend(
                            '<div class="dt-print-heading"><img class="logo" src="'+window.logo+'"/><h2 class="title">'+window.store.name+'</h2><p>Impreso el: '+window.formatDate(new Date())+'</p><h2>Nombre: '+window.customerName+'</h2></div>'
                        );
            ...
            },
            {
                ...
                customize: function (doc) {
                    ...
                    doc.content.splice( 1, 0, {
                        ...
                        alignment: 'center',
                        fontSize: 18,
                        text: 'Nombre: '+window.customerName,
                    });
                    // Create a footer
