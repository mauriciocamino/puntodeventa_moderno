...
function (
    ...
    dt.dataTable({
        "oLanguage": {sProcessing: "<img src='../assets/template/img/loading2.gif'>"},
        "processing": true,
        "dom": 'lfBrtip',
        "serverSide": true,
        ...
        "buttons": [
            {
                ...
                titleAttr: 'Print',
                title: "Informe de pago-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: 'Copy',
                title: window.store.name + " > Informe de pago-"+from+" al "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5, 6 ]
                }
            },
            {
                ...
                titleAttr: 'Excel',
                title: window.store.name + " > Informe de pago",
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5, 6 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        e.preventDefault();
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Informe de pago", title:"Informe de pago", html: thehtml});
    });
