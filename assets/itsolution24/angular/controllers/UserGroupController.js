...
function (
    ...
    dt.dataTable({
        ...
        "buttons": [
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Listado de grupos de usuarios",
                exportOptions: {
                    columns: [ 0, 1 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Listado de grupos de usuarios", title:"Listado de grupos de usuarios", html: thehtml});
    });
