...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Informe de venta (Proveedor)-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Informe de venta (Proveedor)-"+from+" al "+to,
                exportOptions: {
                    columns: [printColumns]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        e.preventDefault();
        var thehtml = dt.html();
        EmailModal({template: "sell-report", subject: "Informe de venta (Proveedor)", title:"Informe de venta (Proveedor)", html: thehtml});
    });
}]);