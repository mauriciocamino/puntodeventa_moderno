...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Enviar listado de devolución-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Enviar listado de devolución-"+from+" al "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Enviar listado de devolución", title:"Enviar listado de devolución", html: thehtml});
    });
}]);