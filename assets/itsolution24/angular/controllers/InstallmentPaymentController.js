...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Pago de instalación-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Listado a plazos-"+from+" al "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Listado de pagos a plazos", title:"Listado de pagos a plazos", html: thehtml});
    });
}]);