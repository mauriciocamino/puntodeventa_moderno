...
function (
    ...
    //=======================================
    // start user Informe de cobranza datatable
    //=======================================
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: " Informe de cobranza-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Informe de cobranza-"+from+" al "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5, 6, 7 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        EmailModal({template: "report", subject: "Informe de cobranza", title:"Informe de cobranza", html: thehtml});
    });
}]);
