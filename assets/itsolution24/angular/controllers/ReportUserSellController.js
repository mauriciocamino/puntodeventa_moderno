        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Sell Report (user wise)-"+from+" al "+to,
                stripHtml: false,
                customize: function ( win ) {
                    $(win.document.body)
                        ...
                        .prepend(
                            '<div class="dt-print-heading"><img class="logo" src="'+window.logo+'"/><h2 class="title">'+window.store.name+'</h2><p>Impreso el: '+window.formatDate(new Date())+'</p><h2>Name: '+window.userName+'</h2></div>'
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Sell Report (user wise)-"+from+" al "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5, 5, 6, 7 ]
                }
            },
