...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Informe del vendedor (artículo)-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Informe del vendedor (artículo)-"+from+" al "+to,
                exportOptions: {
                    columns: [printColumns]
                }
            },
            ...
            },
            {
                ...
                titleAttr: "CSV",
                title: window.store.name + " > Informe del vendedor (artículo)",
                exportOptions: {
                    columns: [printColumns]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        e.preventDefault();
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Informe del vendedor (artículo)", title:"Informe del vendedor (artículo)", html: thehtml});
    });
}]);