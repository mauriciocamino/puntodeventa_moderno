...
function (
    ...
    dt.dataTable({
        ...
        "buttons": [
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Lista de marcas",
                exportOptions: {
                    columns: [ 0, 1, 2, 3 ]
                }
            },
   ...
   // Send Lista de marcas through email
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Lista de marcas", title:"Lista de marcas", html: thehtml});
    });
