...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Informe de impuestos de venta-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Informe de impuestos de venta-"+from+" al "+to,
                exportOptions: {
                    columns: [printColumns]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        e.preventDefault();
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Informe de impuestos de venta", title:"Informe de impuestos de venta", html: thehtml});
    });
}]);