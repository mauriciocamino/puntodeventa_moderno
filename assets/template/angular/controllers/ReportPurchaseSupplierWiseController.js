...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Informe de compra (proveedor)-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Informe de compra (proveedor)-"+from+" al "+to,
                exportOptions: {
                    columns: [printColumns]
                }
            },
	...
	*/
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        e.preventDefault();
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Informe de compra (proveedor)", title:"Informe de compra (proveedor)", html: thehtml});
    });
