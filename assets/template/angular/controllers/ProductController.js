...
function (
    ...
    dt.dataTable({
        ...
        "buttons": [
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Productos",
                exportOptions: {
                    columns: [printColumns]
                }
            },
    ...
    $(document).delegate("#create-product-submit", "click", function(e) {
        ...
        then(function(response) {
            ...
            setTimeout(function() {
                ...
                $("#p_thumb img").attr("src", "../assets/template/img/noimage.jpg");
                $("#p_image").val("");
            }, 100);
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "product-list", subject: "Listado de productos", title:"Listado de productos", html: thehtml});
    });
}]);