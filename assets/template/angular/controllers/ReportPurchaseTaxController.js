...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Informe de impuestos sobre compras-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Informe de impuestos sobre compras-"+from+" al "+to,
                exportOptions: {
                    columns: [printColumns]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        e.preventDefault();
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Informe de impuestos sobre compras", title:"Informe de impuestos sobre compras", html: thehtml});
    });
}]);