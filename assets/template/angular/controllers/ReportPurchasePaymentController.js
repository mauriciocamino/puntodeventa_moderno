...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: 'Print',
                title: "Informe de pago de compra-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: 'Copy',
                title: window.store.name + " > Informe de pago de compra-"+from+" al "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5, 6 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        e.preventDefault();
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Informe de pago de compra", title:"Informe de pago de compra", html: thehtml});
    });
