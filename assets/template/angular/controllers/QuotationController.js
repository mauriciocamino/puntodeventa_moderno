...
function (
        ...
        dt.dataTable({
            ...
            "buttons": [
                ...
                },
                {
                    ...
                    titleAttr: "Copy",
                    title: window.store.name + " > Listado de cotizaciones",
                    exportOptions: {
                        columns: [ 0, 1, 2, 3, 4, 5 ]
                    }
                },
    ...
    $(document).delegate("#edit_customer", "click", function(e) {
        ...
        if (!customerID) {
            swal("Advertencia", "Por favor, seleccione una cliente!");
            return false;
        }
...
buttons: ["Cancelar!", "Continuar!"],
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Listado de cotizaciones", title:"Listado de cotizaciones", html: thehtml});
    });
}]);