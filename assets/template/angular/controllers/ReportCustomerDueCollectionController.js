...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Informe de cobranza vencida-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Informe de cobranza vencida-"+from+" al "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Informe de cobranza vencida", title:"Informe de cobranza vencida", html: thehtml});
    });
