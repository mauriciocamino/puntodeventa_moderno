...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Lista de productos caducados",
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Lista de productos caducados",
                exportOptions: {
                    columns: [printColumns]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Listado de productos / caducados", title:"Listado de productos / caducados", html: thehtml});
    });
}]);