...
function (
    ...
    $("#invoice-invoice-list").dataTable({
        ...
        "aoColumns": [
            ...
            {data : "amount"},
            {data : "btn_view"},
            {data : "btn_edit","visible": false,},
            {data : "btn_delete","visible": false,}
        ],
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Lista de devolución de compra-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Lista de devolución de compra-"+from+" al "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Lista de devolución de compra", title:"Lista de devolución de compra", html: thehtml});
    });
}]);