...
function (
    ...
    dt.dataTable({
        ...
        "buttons": [
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Lista de la tienda",
                exportOptions: {
                    columns: [ 0, 1, 2, 4 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Listado de almacenes", title:"Listado de almacenes", html: thehtml});
    });
