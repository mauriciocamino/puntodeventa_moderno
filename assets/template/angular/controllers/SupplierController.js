...
function (
    ...
    dt.dataTable({
        ...
        "buttons": [
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Listado de proveedores",
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5 ]
                }
            },
   ...
   // Send Listado de proveedores through email
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Listado de proveedores", title:"Listado de proveedores", html: thehtml});
    });
