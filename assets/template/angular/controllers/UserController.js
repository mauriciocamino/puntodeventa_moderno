...
function ($scope,
    ...
    dt.dataTable({
        ...
        "buttons": [
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Lista de usuarios",
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5 ]
                }
            },
    ...
    // Send Lista de usuarios through email
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Listado de usuarios", title:"Listado de usuarios", html: thehtml});
    });
