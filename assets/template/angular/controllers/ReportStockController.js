...
function (
            ...
            "buttons": [
                {
                    ...
                    titleAttr: "Print",
                    title: " Informe de stock-"+from+" al "+to,
                ...
                },
                {
                    ...
                    titleAttr: "Copy",
                    title: window.store.name + " > Informe de stock-"+from+" al "+to,
                    exportOptions: {
                        columns: [ 0, 1, 2, 3, 4, 5 ]
                    }
                },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        EmailModal({template: "report", subject: "Informe de stock", title:"Informe de stock", html: thehtml});
    });
