...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Listado de transacciones-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Listado de transacciones-"+from+" al "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5, 6 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Lista de transacciones bancarias", title:"Lista de transacciones bancarias", html: thehtml});
    });
}]);
