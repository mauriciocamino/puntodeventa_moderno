...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Listado de gastos-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Listado de gastos-"+from+" al "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4 ]
                }
            },
            {
                ...
                titleAttr: "Excel",
                title: window.store.name + " > Listado de gastos",
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4 ]
                }
            },
        ...
        .then(function (willDelete) {
            if (willDelete) {
                ...
                .then(function (response) {
                    ...
                    window.swal("Advertencia!", "Gasto eliminado correctamente!", "success");
                }, function (response) {
                    window.swal("Oops!", "Incapaz de borrar!", "error");
                });
            }
        });
    });
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Listado de gastos", title:"Listado de gastos", html: thehtml});
    });
}]);