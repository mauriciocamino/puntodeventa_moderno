...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Listado de préstamos-"+from+" al "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Listado de préstamos-"+from+" al "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 4, 5, 6, 7 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Listado de préstamos", title:"Listado de préstamos", html: thehtml});
    });
}]);