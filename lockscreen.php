...
<body class="lockscreen">
  ...
  <div class="lockscreen-wrapper">
    <h4 class="text-center text-green text-capitalize"><?php echo  store('name') ?></small></h4>
    <br>
    ...
    <div class="lockscreen-item">
      <div class="lockscreen-image">
        ...
        <?php else : ?>
          <img src="<?php echo root_url();?>/assets/template/img/nopeople.png">
        <?php endif; ?>
      </div>
      <form class="lockscreen-credentials" action="" method="post" autocomplete="off">
        <div class="input-group">
          <input class="form-control" type="password" name="password" placeholder="Contraseña" autocomplete="off" autofocus>
    ...
    <div class="text-center">
      <a href="index.php" style="font-size:1.8rem;color:green;text-decoration:underline;"><small></small> Regresar al Login</a>
    </div>
    <div class="lockscreen-footer text-center">
      <div class="copyright" style="font-size:1.2rem;">Copyright © <?php echo date('Y'); ?> <a href=""></a></div>
    </div>
  </div>
