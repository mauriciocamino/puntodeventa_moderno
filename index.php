...
{
  $statement = db()->prepare("INSERT INTO `login_logs` SET `ip` = ?, `status` = ?, `created_at` = ?");
  $statement->execute(array(get_real_ip(), 'error',date_time()));
}
...
<head>
  ...
  <?php if ($store->get('favicon')): ?>
    <link rel="shortcut icon" href="assets/template/img/logo-favicons/<?php echo $store->get('favicon'); ?>">
    <?php else: ?>
    ...
    <?php if (DEMO || USECOMPILEDASSET) : ?>
      ...
      <!-- LOGIN COMBINED CSS -->
      <link type="text/css" href="assets/template/cssmin/login.css" rel="stylesheet">
      ...
      <?php else : ?>
        ...
        <!-- Theme CSS -->
        <link type="text/css" href="assets/template/css/theme.css" rel="stylesheet">

        <!-- Login CSS -->
        <link type="text/css" href="assets/template/css/login.css" rel="stylesheet">
      ...
      <?php if (DEMO || USECOMPILEDASSET) : ?>
        ...
        <!-- Login Combined JS -->
        <script src="assets/template/jsmin/login.js"></script>
        ...
        <?php else : ?>
          ...
          <!-- Login JS -->
          <script src="assets/template/js/login.js"></script>
      ...
      <body class="login-page">
        ...
        <section class="login-box">
          <div class="login-cover">
           ...
           <div class="login-cover-image" style="background-image: url(storage/products/login-bg-16.jpg);position: fixed;top: 0;left: 0;right: 0;bottom: 0;background-size: cover;background-repeat: no-repeat;background-position: center;transition: background .2s linear;" data-id="login-cover-image"></div>
   ...
   <!--      <div class="login-box-body" ng-controller="LoginController"> -->
      <!--     <p class="login-box-msg" style="position: relative;">
          ...
          <form id="login-form" action="login.php" method="post"> 
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="Email / # Telefono." name="username">
            </div><br>

            <div class="input-group">
              <span class="input-group-addon" id="basic-addon1"><i class="glyphicon glyphicon-lock"></i></span>
              <input type="password" class="form-control" placeholder="Contrseña" name="password">
            </div><br>

                <button type="submit" id="login-btn" class="btn btn-success btn-block btn-flat" data-loading-text="Ingresando...">
         ...
         <!--    </div> -->
          ...
          <noscript>Necesita tener JavaScript habilitado para poder usar <strong><?php echo store('name');?></strong>.</noscript>
        </body>
        </html>