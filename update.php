...
<html lang="es">
  <head>
    ...
    <title>Actualizar Modern POS de v2.0 - v3.0</title>
...
<div class="container">
        ...
        <div class="col-sm-8 col-sm-offset-2">
            <div class="panel panel-default header" style="">
                <div class="panel-heading text-center">
                    <h2>Actualizar Modern POS de v2.0 - v3.0</h2>
                    <h1>STEP 
                ...
                <?php if (!isset($request->get['update'])):?>
                    <div class="panel-body">
                        ...
                        <h4 class="bg-info" style="padding:10px;"><b>TOMA COPIA DE SEGURIDAD DE TODOS LOS ARCHIVOS</b></h4>
                        </div>
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="col-sm-8 col-sm-offset-2">  
                        ...
                        <?php if (isset($request->get['update']) && $request->get['update'] == 'yes'):
                            ...
                            ?>
                                ...
                                <label for="host" class="col-sm-3 control-label">
                                    <p>Nombre de host <span class="text-aqua">*</span></p>
                                </label>
                                <div class="col-sm-7">
                            ...
                            ?>
                                <label for="database" class="col-sm-3 control-label">
                                    <p>Nombre de la base de datos <small>of v2.0</small> <span class="text-aqua">*</span></p>
                                </label>
                                <div class="col-sm-7">
                            ...
                            ?>
                                <label for="user" class="col-sm-3 control-label">
                                    <p>Nombre de usuario de la base de datos <span class="text-aqua">*</span></p>
                                </label>
                                <div class="col-sm-7">
            ...
            <div class="text-center copyright">&copy; <a href="">universalsoftare.com</a>,Todos los derechos reservados.</div>
        </div>
    </div>
</div>
