...
$subdominio = explode('.', isset($host["host"]) ? $host["host"] : $host["path"] )[0];
...
define('SYNCSERVERURL', 'http://posmoderno.miaccesoweb.com/sync.php');
 ...
 */
if (!file_exists(ROOT.'/storage/products/'.$subdominio))
    mkdir(ROOT.'/storage/products/'.$subdominio, 0775);
    
define('FILEMANAGERPATH', ROOT.'/storage/products/'.$subdominio);
