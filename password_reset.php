...
<head>
  ...
  <title>Restablecimiento de contraseña | <?php echo store('name'); ?></title>
  ...
  <?php else : ?>
    ...
    <!-- Forgot Password JS-->
    <script src="assets/template/js/forgot-password.js"></script>
...
<div class="hidden"><?php include('assets/template/img/iconmin/membership/membership.svg');?></div>
  ...
  <section class="login-box">
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="">Sistem Pos_</a>, v<?php echo settings('version'); ?></p>
    </div>
  </section>
